...
import { parseJsonArray, timeAgo, BADGE_EMOJI } from "@/lib/utils";
...
export default async function HomePage({ searchParams }: PageProps) {
  ...
  for (const q of popularTags) {
    for (const t of parseJsonArray(q.tags)) {
          ...
          <div className="compose-box animate-fade-up">
            ...
            <div className="flex items-center justify-between mt-3 pt-3 border-t border-app-border dark:border-dark-border">
              <div className="flex items-center gap-4">
                <button className="flex items-center gap-1.5 text-app-muted text-sm hover:text-honey transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mb-1.5">
                        ...
                        <div>
                          ...
                          {tags[0] && (
                            <Link href={`/?tag=${tags[0]}`} className="tag-chip">
                              #{tags[0]}
                            </Link>
                          )}
                        </div>
                      ...
                      <div className="flex items-center gap-5 mt-3">
                        ...
                        <button className="flex items-center gap-1.5 text-app-muted text-xs hover:text-app-text transition-colors">
                          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="sidebar-card">
          ...
          <div className="space-y-2.5">
            {topTags.map(([tag, score], i) => (
              <Link key={tag} href={`/?tag=${tag}`} className="block group">
            ...
            <Link href="/explore" className="text-honey text-xs font-semibold hover:text-honey-dark transition-colors">
              Daha fazla göster
            </Link>
          </div>
        </div>
