...
export default async function ProfilePage({ params, searchParams }: PageProps) {
  ...
  const TABS = [
    ...
    { key: "saved", label: "Kaydedilen Kovanlar", count: 0 },
  ];
    ...
    <div className="max-w-5xl mx-auto px-4 py-6">
          ...
          <div className="flex-1">
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center gap-2">
                {isOwn && (
                  <button className="btn-outline text-sm" id="edit-profile-btn">
                    Profili Düzenle
                  </button>
                )}
      ...
      <div className="flex gap-6">
        ...
        <div className="flex-1 min-w-0">
          ...
          {tab === "saved" && (
            <p className="text-app-muted text-sm py-8 text-center">Kaydedilen kovan özelliği yakında geliyor.</p>
          )}
        </div>
        ...
        <div className="w-64 flex-shrink-0">
          <div className="sidebar-card">
            ...
            {[
              ...
              { label: "Başlatılan Kovanlar", value: 0 },
            ].map((s) => (
